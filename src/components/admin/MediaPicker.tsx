    ...
    <div className="rounded-lg border border-[var(--admin-border)] bg-[var(--admin-surface)] p-4">
      ...
      {value && (
        <>
          ...
          <div className="mt-3 aspect-video overflow-hidden rounded-lg border border-[var(--admin-border)] bg-black">
            <MediaRenderer
              mediaUrl={value}
              mediaType={(mediaType as MediaType) || inferMediaType(value)}
              autoPlay={true}
              mediaFit="contain"
