...
hasAll(css, [
  ...
  "Public Home logo size tune",
  "Public Home logo final size lock",
  "Public Home logo EOF final size lock",
  "Global brand logo visibility lock",
  ".tenant-logo-slot-image",
  ".premium-site-header .public-nav-brand-logo",
  ".checkout-modal-logo.tenant-logo-slot-image",
  ".admin-sidebar-brand-link",
  ".admin-topbar-logo-slot",
