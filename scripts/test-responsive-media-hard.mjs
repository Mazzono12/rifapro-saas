...
for (const [path, tokens] of [
  ...
  ["src/pages/Fazendinha.tsx", ["const config = data?.config", "Array.isArray(data?.winners)", "CheckoutCampaignMedia", "PrizeCard"]],
  ["src/components/FazendinhaSection.tsx", ["ResponsiveMediaFrame", "DynamicMedia", "safeGroupNumbers", "CheckoutCampaignMedia"]],
